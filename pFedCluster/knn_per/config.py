...
def get_args():
    ...
    # kNN-Per
    parser.add_argument('--knn_k', type=int, default = 10, help='The k nearest neighbors')
    parser.add_argument('--interpolation', type=float, default=0.5, help='interpolation parameter')
    # attack
    parser.add_argument('--attack_type', type=str, default="shuffle")
